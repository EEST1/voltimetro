 ...
 * https://github.com/EEST1/Ap_template/tree/inicializado
 */
/*
...
unsigned char mux_tout = 0; // se declara para ser usada en la multiplexación
                            // del display

void main(void) {
    //Aquí debemos declarar todas las variables:
    unsigned char a=0,b=1;         //las variables locales deben de ser cargadas
    unsigned char faon=0,faoff=0;  //con un valor inicial, de lo contrario
    ...
    //di();    //descomente esta línea para inhabilitar todas las interrupciones
    ...
    while(1){   //aquí se encuentra el bucle principal
